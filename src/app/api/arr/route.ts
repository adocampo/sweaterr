...
// Unified Newznab-style endpoint: /api/arr?t=caps|search|tvsearch|movie|get&apikey=<forum-api-key>
// Each forum has its own API key (stored in torznabApiKey field for compatibility)
