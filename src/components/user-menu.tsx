...
import { User, LogOut, Languages, Moon, Sun, Monitor } from 'lucide-react';
...
export function UserMenu({ user, onThemeChange, currentTheme = 'system' }: UserMenuProps) {
    ...
    const handleLogout = async () => {
        ...
        try {
            ...
            // Force full reload to ensure cookie is cleared and middleware sees it
                ...
                <DropdownMenuSub>
                    ...
                    <DropdownMenuSubContent>
                        <DropdownMenuItem
                            ...
                            className={currentTheme === 'system' ? 'bg-slate-100 dark:bg-slate-800' : ''}
                        >
