...
## Paso 1: Crear Servicio *arr en Sweaterr
...
4. Busca la sección **"\*arr Services"**
5. Click en **"Añadir Servicio"**
6. Selecciona el tipo:
   - **Sonarr** - Para series de TV
   - **Radarr** - Para películas
   - **Lidarr** - Para música
   - **Readarr** - Para libros/ebooks
7. Dale un nombre descriptivo (ej: "Sonarr Casa", "Radarr 4K")
8. Click **"Guardar"**
9. **¡IMPORTANTE!** Copia la **API Key** generada (aparece en la tarjeta del servicio)
   - Formato: `fdd-xxxxxxxxxxxxxxxxxxxx`
