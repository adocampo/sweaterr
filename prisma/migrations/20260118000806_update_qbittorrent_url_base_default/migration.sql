...
CREATE TABLE "new_forums" (
    ...
    "qbittorrentUrlBase" TEXT DEFAULT '/api/qbittorrent',
...
INSERT INTO "new_forums" ("baseUrl", "cookiesUpdatedAt", "createdAt", "cseId", "defaultLanguage", "enabled", "flaresolverrSessionTTL", "id", "infohashSelector", "linksContainerSelector", "loginFormSelector", "loginPath", "magnetUriSelector", "name", "passwordField", "peersSelector", "persistentCookies", "postTitleSelector", "protocol", "qbittorrentUrlBase", "searchForumLabel", "searchInChildForums", "searchMode", "searchPath", "searchTitleOnly", "seedersSelector", "thankButtonSelector", "torznabApiKey", "updatedAt", "usernameField") SELECT "baseUrl", "cookiesUpdatedAt", "createdAt", "cseId", "defaultLanguage", "enabled", "flaresolverrSessionTTL", "id", "infohashSelector", "linksContainerSelector", "loginFormSelector", "loginPath", "magnetUriSelector", "name", "passwordField", "peersSelector", "persistentCookies", "postTitleSelector", "protocol", "qbittorrentUrlBase", "searchForumLabel", "searchInChildForums", "searchMode", "searchPath", "searchTitleOnly", "seedersSelector", "thankButtonSelector", "torznabApiKey", "updatedAt", "usernameField" FROM "forums";
DROP TABLE "forums";
